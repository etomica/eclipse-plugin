...
public class ConfigurationCanvas3D extends ConfigurationCanvas {
    
    private int[] shiftOrigin = new int[2];     //work vector for drawing overflow images
        
    public ConfigurationCanvas3D(Composite parent) {
    	super(parent);
    }
...
////        }
    ...
    DisplayPhaseCanvas3DOpenGL canvas = new DisplayPhaseCanvas3DOpenGL(null, 300, 300);
    
    private static class CanvasOpenGL extends GLAnimCanvas {
        public CanvasOpenGL() {
        	this(300,300);
        }
        public CanvasOpenGL(int width, int height) {
            super(width, height);
            setBackground(java.awt.Color.black);
        }

    }//end of CanvasOpenGL
}  //end of ConfigurationCanvas3D
